...
var eventMapping = {
    ...
    eventTime: {
        ...
        transformer: function (value) {
            return "".concat(new Date(value).toISOString().split('.')[0], "+0000");
        }
    },
    eventData: {
        "abandoned checkout url": {
            ...
            transformer: function (value) {
                return "".concat(process.env.CHECKOUT_BASE_URL, "?tokenId=").concat(value);
            }
        },
...
console.log((new jsonMapper_1.JsonMapper().map(eventMapping, analyticsData)));
